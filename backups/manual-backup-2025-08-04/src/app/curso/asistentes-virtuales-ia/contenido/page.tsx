...
export default function ContenidoAsistentesVirtualesIAPage() {
  ...
  const {
    ...
    markLessonComplete,
    setCurrentLesson
  } = useCourseProgress('asistentes-virtuales-ia', isEnrolled);
  ...
  const courseData = {
    ...
    lessons: [
      // MÓDULO 1 - Sublecciones
      {
        ...
        duration: '12 min',
        type: 'video',
        description: 'Comprende qué son los asistentes virtuales empresariales y sus beneficios clave',
      ...
      },
      {
        ...
        duration: '10 min',
        type: 'video',
        description: 'Descubre los beneficios clave de implementar asistentes virtuales en tu empresa',
        videoUrl: 'https://www.youtube.com/watch?v=example1-2',
        content: `
          <h2>1.2 Beneficios Empresariales Clave</h2>
          
          <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 1.5rem; margin: 1.5rem 0;">
            <p style="margin: 0; color: #475569; line-height: 1.6;">Los asistentes virtuales empresariales ofrecen ventajas significativas que transforman la operación de tu negocio. Conoce los beneficios clave que puedes obtener al implementar esta tecnología.</p>
          </div>
          
          <h3 style="color: #1e293b; margin: 2rem 0 1rem 0;">Eficiencia Operativa</h3>
          <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 1.5rem; margin: 1rem 0;">
            <ul style="margin: 0; color: #475569; line-height: 1.7;">
              <li style="margin: 0.5rem 0;">✓ Reducción del 70% en tiempo de respuesta a consultas</li>
              <li style="margin: 0.5rem 0;">✓ Automatización de tareas repetitivas</li>
      ...
      },
      {
        ...
        duration: '15 min',
        type: 'video',
        description: 'Análisis comparativo entre Google Gemini y ChatGPT para elegir la mejor opción',
      ...
      },
      {
        ...
        duration: '8 min',
        type: 'video',
        description: 'Define la estrategia y planificación para implementar tu asistente virtual',
      ...
      // MÓDULO 2 - Sublecciones
      {
        ...
        duration: '20 min',
        type: 'lab',
        description: 'Crea el perfil empresarial completo que será el ADN de tu asistente virtual',
      ...
      },
      {
        ...
        duration: '25 min',
        type: 'lab',
        description: 'Prepara todos los documentos esenciales que necesitará tu asistente virtual',
      ...
      },
      {
        ...
        duration: '15 min',
        type: 'video',
        description: 'Aprende las mejores prácticas para optimizar tu contenido para que la IA lo procese eficientemente',
      ...
      // MÓDULO 3 - Sublecciones
      {
        ...
        duration: '15 min',
        type: 'lab',
        description: 'Aprende paso a paso cómo configurar tu primer GEM en Google Gemini',
      ...
      },
      {
        ...
        duration: '20 min',
        type: 'lab',
        description: 'Configura las instrucciones master que definirán el comportamiento de tu asistente',
      ...
      },
      {
        ...
        duration: '10 min',
        type: 'lab',
        description: 'Configura las herramientas y carga los documentos que necesitará tu asistente',
      ...
      },
      {
        ...
        duration: '10 min',
        type: 'video',
        description: 'Aprende las mejores formas de iniciar conversaciones con tu nuevo asistente GEM',
  ...
  const handleCompleteCourse = async () => {
    ...
    try {
      const response = await fetch('/api/courses/complete-course', {
        ...
        credentials: 'include',
        body: JSON.stringify({
          courseSlug: 'asistentes-virtuales-ia'
        })
      });
  ...
  if (!isEnrolled) {
    return (
      <div className="enrollment-required">
        ...
        <button onClick={() => router.push('/curso/asistentes-virtuales-ia')}>
          Volver al curso
        </button>
      </div>
    );
            ...
            <div className="course-header-content">
              <div className="course-breadcrumb">
                <div className="breadcrumb-container">
                  ...
                  <span className="breadcrumb-separator">/</span>
                  <a href="/curso/asistentes-virtuales-ia" className="breadcrumb-item">
                    <span className="breadcrumb-icon">🤖</span>
                    <span className="breadcrumb-text">Asistentes virtuales con IA</span>
                  </a>
                  <span className="breadcrumb-separator">/</span>
