          ...
          <div className="container">
            <div className="learning-objectives">
              ...
              <div className="course-introduction">
                <p>
                  La <strong>visión por computador</strong> es una de las ramas más fascinantes de la 
                  inteligencia artificial, que permite a las máquinas "ver" y entender el mundo visual 
                  como lo hacemos los humanos. Esta tecnología está revolucionando industrias desde 
                  la medicina hasta los vehículos autónomos.
                </p>
                
                <p>
                  En este curso aprenderás los fundamentos teóricos y prácticos de computer vision, 
                  desde el procesamiento básico de imágenes hasta técnicas avanzadas de deep learning 
                  para reconocimiento de objetos, detección facial y análisis de video.
                </p>
                
                <p>
                  Al finalizar tendrás las habilidades para implementar soluciones de visión artificial 
                  en proyectos reales, utilizando las herramientas y frameworks más populares de la industria.
                </p>
              </div>
