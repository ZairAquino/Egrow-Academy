...
export default function FundamentosMLPage() {
  ...
  const goToCourseContent = async () => {
    ...
    if (!user) {
      ...
      const loginUrl = `/login?redirect=/curso/fundamentos-ml/contenido`;
    ...
    const contentUrl = '/curso/fundamentos-ml/contenido';
  ...
  return (
    <>
      ...
      <main className="main-content">
        {/* Hero Section */}
        <section className="hero-section pt-14 md:pt-[95px]">
          ...
          <div className="container">
            <div className="learning-objectives">
              ...
              <div className="course-introduction">
                <p>
                  Los <strong>fundamentos de Machine Learning</strong> son esenciales para cualquier 
                  profesional que quiera entender y aplicar inteligencia artificial en el mundo real. 
                  Este curso te proporcionará una base sólida en los conceptos, algoritmos y técnicas 
                  más importantes del aprendizaje automático.
                </p>
                
                <p>
                  Desde conceptos básicos como regresión lineal hasta técnicas avanzadas como redes 
                  neuronales, aprenderás de forma práctica cómo funcionan los algoritmos de ML y 
                  cómo aplicarlos para resolver problemas reales en diferentes industrias.
                </p>
                
                <p>
                  Este curso combina teoría sólida con implementación práctica, utilizando Python 
                  y las librerías más populares como scikit-learn, pandas y numpy para que puedas 
                  aplicar inmediatamente lo aprendido en proyectos reales.
                </p>
              </div>
