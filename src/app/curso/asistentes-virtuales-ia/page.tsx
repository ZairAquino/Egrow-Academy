...
export default function AsistentesVirtualesIAPage() {
  console.log('🔍 [DEBUG] Componente AsistentesVirtualesIAPage cargado');
  ...
  const courseData = {
    ...
    instructor: {
      ...
      bio: 'Experto en implementación de asistentes virtuales con IA y automatización de procesos empresariales con más de 5 años de experiencia en el sector.'
    },
    prerequisites: [
    ...
    whatYouWillLearn: [
      ...
      'Creación de asistentes personalizados con ChatGPT',
      'Automatización de tareas empresariales',
      'Integración de asistentes en flujos de trabajo',
      'Optimización de prompts para asistentes',
      'Gestión de conversaciones y contexto',
      'Implementación en diferentes industrias',
    ...
    tools: [
      ...
      'APIs de integración',
      'Plataformas de gestión de workflow'
    ],
    lessons: [
      {
        id: 1,
        title: 'MÓDULO 1: Fundamentos y Planificación Estratégica',
      ...
      {
        id: 3,
        title: 'MÓDULO 3: Creación de Asistente con Google Gemini',
      ...
      {
        id: 4,
        title: 'MÓDULO 4: Creación de Asistente con ChatGPT',
              ...
              <div className="main-content-area desktop-content">
                ...
                <div className="learning-objectives">
                  ...
                  <div className="course-introduction">
                    <p>
                      Los <strong>asistentes virtuales con inteligencia artificial</strong> están transformando 
                      la manera en que las empresas interactúan con sus clientes y gestionan sus procesos internos. 
                    ...
                    <p>
                      Este curso te guiará paso a paso en la creación e implementación de asistentes virtuales 
                      para diferentes casos de uso empresariales. Aprenderás desde la configuración básica hasta 
                      técnicas avanzadas de optimización y automatización.
                    </p>
                    
                    <p>
                      A través de ejercicios prácticos y casos reales, dominarás las herramientas más potentes 
                      del mercado y podrás implementar soluciones que generen un impacto real en tu organización 
